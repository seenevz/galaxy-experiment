...
const generateGalaxy = () => {
  ...
  for (let i = 0; i < galaxyParams.count; i++) {
    ...
    const randomX = Math.pow(Math.random(), galaxyParams.randomnessPow) * (Math.random() < 0.5 ? 1 : -1) * galaxyParams.randomness * radius
    const randomY = Math.pow(Math.random(), galaxyParams.randomnessPow) * (Math.random() < 0.5 ? 1 : -1) * galaxyParams.randomness * radius
    const randomZ = Math.pow(Math.random(), galaxyParams.randomnessPow) * (Math.random() < 0.5 ? 1 : -1) * galaxyParams.randomness * radius
...
gui.add(galaxyParams, 'radius').min(0.01).max(20).step(0.01).onFinishChange(generateGalaxy);
...
gui.add(galaxyParams, 'randomnessPow').min(1).max(10).step(0.001).onFinishChange(generateGalaxy);
